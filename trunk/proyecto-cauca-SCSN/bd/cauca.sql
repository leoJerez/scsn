...
/* Created on:     16/05/2013 03:03:50 p.m.                     */
/*==============================================================*/
...
/*==============================================================*/
create table eje (
   id_esquema_eje       int4                 not null,
   posicion             int4                 not null,
   tipo_eje             char(1)              not null,
   status               char(1)              not null,
   constraint pk_eje primary key (posicion, id_esquema_eje)
);
...
create table vehiculo (
   ...
   id_modelo_vehiculo   int4                 not null,
   status               char(1)              not null,
...
alter table eje
   add constraint fk_eje_reference_esquema_ foreign key (id_esquema_eje)
...
alter table vehiculo
   add constraint fk_vehiculo_reference_modelo_v foreign key (id_modelo_vehiculo)
      references modelo_vehiculo (id_modelo_vehiculo)
      on delete restrict on update restrict;
